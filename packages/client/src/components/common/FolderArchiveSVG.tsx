...
interface FolderArchiveSVGProps {
  size?: number;
}

const FolderArchiveSVG: React.FC<FolderArchiveSVGProps> = ({ size = 64 }) => {
  return (
    <svg
      width="195"
      height="131"
    ...
    >
      <rect width="195" height="87.6345" rx="20" fill="#E4E4E4" />
      <g filter="url(#filter0_i_4625_401)">
        <path
          ...
          fill="url(#paint0_linear_4625_401)"
        />
      </g>
      <defs>
        <filter
          id="filter0_i_4625_401"
          x="0"
          y="13.5508"
          width="195"
          height="118.449"
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_4625_401"
          />
        </filter>
        <linearGradient
          id="paint0_linear_4625_401"
          x1="97.5"
          y1="13.5508"
          x2="97.5"
          y2="130.999"
...
export default FolderArchiveSVG;
