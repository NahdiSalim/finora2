...
export const buildFactureTemplate = (facture: Facture): string => {
  // Note: Company info is not included in the simplified Facture type
  // You can fetch it separately if needed, or just show client info

  // Build issuer lines - would need to be passed separately or fetched
