...
export default function ConvertToBcModal({
  open,
  devis,
  isLoading,
  onConfirm,
    ...
    >
      ...
      <DialogContent sx={{ px: 3, py: 2.5 }}>
        <Typography variant="body2" color="text.secondary" lineHeight={1.7}>
          ...
          sera converti en bon de commande brouillon avec les mêmes lignes et le
          même fournisseur. Un numéro sera attribué automatiquement.
        </Typography>
      </DialogContent>
