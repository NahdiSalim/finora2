...
export default function ChatHeader({
  ...
  return (
    ...
    >
      ...
      >
        {/* Call and Video buttons - visible for all conversations */}
        {conversation && (
          <>
            <IconButton
              onClick={() => {
                console.log("Audio call initiated for:", conversation.name);
              }}
              sx={{
            ...
            <IconButton
              onClick={() => {
                console.log("Video call initiated for:", conversation.name);
              }}
              sx={{
                width: isMobile ? 34 : 40,
                height: isMobile ? 34 : 40,
