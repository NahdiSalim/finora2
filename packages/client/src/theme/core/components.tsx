...
const MuiAutocomplete: Components<Theme>['MuiAutocomplete'] = {
  ...
  styleOverrides: {
    option: ({ theme }) => ({
      ...
      '&[aria-selected="true"]': {
        backgroundColor: `${theme.vars.palette.action.selected} !important`,
      },
...
const MuiDateCalendar: Components<Theme>['MuiDateCalendar'] = {
  styleOverrides: {
    root: ({ theme }) => ({
      width: 'auto',
      '& .MuiPickersDay-root': {
...
const MuiMonthCalendar: Components<Theme>['MuiMonthCalendar'] = {
  styleOverrides: {
    root: ({ theme }) => ({
